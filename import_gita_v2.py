    ...
    try:
        ...
        for chapter_idx, chapter in enumerate(gita_data['chapters'], 1):
            ...
            chapter_node = ContentNode(
                ...
                level_name="Adhyaya",
                level_order=0,
                sequence_number=chapter_number,  # INTEGER
            ...
            for verse in verses:
                ...
                verse_node = ContentNode(
                    ...
                    level_name="Shloka",
                    level_order=1,
                    sequence_number=verse_num,  # INTEGER
                    title_english=f"Verse {verse_num}",
                    title_sanskrit="",
                    title_transliteration=verse.get('transliteration', '')[:100] if verse.get('transliteration') else '',
                    has_content=bool(verse.get('slok') or verse.get('translation')),
                    content_data={
        ...
        print(f"   (18 chapters + {total_verses} verses)")
