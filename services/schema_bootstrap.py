...
def ensure_phase1_schema(database_url: str) -> None:
    ...
    statements = [
        ...
        """,
        """
        CREATE INDEX IF NOT EXISTS idx_word_meaning_entries_node_id ON word_meaning_entries(node_id);
        """,
        """
        CREATE INDEX IF NOT EXISTS idx_word_meaning_entries_language ON word_meaning_entries(node_id, language_code);
        """,
        """
