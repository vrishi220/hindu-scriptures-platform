...
const BACKEND_UNAVAILABLE = "AI generation service unavailable. Please try again shortly.";
...
export async function proxyAiGenerateRequest(request: Request, pathSuffix = "") {
  ...
  const doRequest = (token?: string) => {
    ...
    return fetch(`${API_BASE_URL}/api/ai/generate${pathSuffix}${search}`, {
      method,
      headers,
      body: bodyText,
      cache: "no-store",
