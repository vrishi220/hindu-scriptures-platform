        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-6">
            ...
            <div className="hidden items-center gap-4 text-sm text-zinc-600 sm:flex">
              ...
              <a href="/explorer" className="font-semibold text-[color:var(--deep)]">
                Explorer
              </a>
              {canAdmin && (
                <>
          ...
          <div className="relative flex flex-col items-end gap-2">
            {authEmail ? (
              ...
              <>
                ...
                {showLogin && (
                  <form
                    className="fade-in absolute right-0 top-full z-10 mt-2 w-72 rounded-2xl border border-black/10 bg-white/95 p-4 shadow-lg"
